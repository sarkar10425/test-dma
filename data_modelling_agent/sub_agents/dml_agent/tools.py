...
import numpy as np
import pandas as pd
from .utils.commons import get_env_var
...
def get_database_settings(ddl_schema, project_id, dataset_id):
    """Get database settings."""
    global database_settings
    if database_settings is None:
        database_settings = update_database_settings(ddl_schema, project_id, dataset_id)
    return database_settings


def update_database_settings(ddl_schema, project_id, dataset_id):
    """Update database settings."""
    global database_settings
    ddl_schema = cleanup_ddl(ddl_schema, project_id, dataset_id)
    database_settings = {
