...
# from .tools import ddl_agent, user_rule_agent
...
#         sub_agents=[ddl_agent],
#         )

# conceptual_model_agent = SequentialAgent(
#     name="ConceptualModelAgent",
#     sub_agents=[
#         parallel_agent,
#         modelling_agent
#     ],
...
# conceptual_model_agent_with_hitl = LoopAgent(
#     name="ConceptualModelAgent",
#     sub_agents=[modeller_agent
#     ],
#     description="Creates a data model and refines it in a loop",
#     max_iterations = 1,
# )
