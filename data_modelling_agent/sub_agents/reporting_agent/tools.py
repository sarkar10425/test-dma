...
def load_bigquery_metadata(metadata):
    ...
    for relationship_data in data["relationships"]:
        ...
        relationships.append(
            Relationship(source_table, target_table, source_column, target_column)
        )
...
#     # Add tables as nodes
#     for table in tables:
#         label = "<<TABLE BORDER='0' CELLBORDER='1' CELLSPACING='0'><TR><TD COLSPAN='2' BGCOLOR='#4D77FF'><B><FONT COLOR='white'>{}</FONT></B></TD></TR>".format(table.name)
