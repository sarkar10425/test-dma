AGENT_INTRODUCTION_MINIFIED = """
# I am Merlin: Your Intelligent Data Architect

Welcome! I am not just a schema generator; I am a deep-reasoning engine designed to bridge the gap between your Custom EDW Models, Complex industry requirements and optimized BigQuery implementations.

---
### **What I Do**

I architect data models by analyzing the intersection of **structure and usage**. My design logic goes deep:

* **Usage-Driven Optimization:** I analyze your BI SQL queries (100's of them) to identify patterns which I then intelligently use to decide on things like de-normalizations, column persistance, create new Fact and derived tables and much more
* **Performance Engineering:** I automate partitioning and clustering strategies based on real-world data profiles and query heatmaps.
* **Industry-Aligned:** I leverage global blueprints for precision, including **FHIR** (Healthcare), **FOCUS** (FinOps), and my upcoming roadmap includes **FSLDM** (Financial Services).
---

### **Current Use-Case: Cloud FinOps**

I am currently pre-configured to handle **Cloud FinOps** workloads. By utilizing the **FOCUS (FinOps Cost and Usage Specification)** methodology, I ensure your data model is standardized, billable, and ready for advanced cost transparency.

### **Getting Started**
To provide high-fidelity architecture, I require a rich context of source DDLs, Industry Blueprints, BI query logs, and data profiles.
> **Note:** In this release, please **contact the Admin Team** to configure these data-stores for your specific use-case. We are working to make this a seamless, self-service experience in the next update!

📖 **[View the User Documentation](https://docs.google.com/document/d/1G8K_rQy43hGH0WblVmh8lnPwhaQQYkQgzzvqXuGJa7E/edit?tab=t.0#heading=h.tc3lhkve93hr)**

---

### **Your Journey**
Your journey from raw requirements to a live warehouse follows this rigorous flow:

0. **Metadata Preprocessing**  *Pre-configured*
1. **Entity Classification** 📍 *You are here*
2. **Conceptual Data Model**
3. **Logical Data Model**
4. **Physical Data Model**
5. **Validations**
6. **Deployment to BigQuery**
"""
...
*   **What it creates:** Entity Classifications, Conceptual Data Models, Logical Data Models, Physical DDL scripts (`CREATE TABLE ...`), and detailed metadata in JSON format.
*   **Use Cases & Examples:**
