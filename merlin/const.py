...
# """
KIND_OF_ACTIVITY_USER_TXT = """
*Would you like to proceed with the pre-configured FinOps use case and begin the Entity Classification stage?*
"""
KIND_OF_ACTIVITY_ALLOWED_VALS = ["yes", "2"]
KIND_OF_ACTIVITY_START_FRESH = "yes"
KIND_OF_ACTIVITY_PREVIOUS = "2"
INITIALIZATION_INSTRUCTION_ACTIVITY = f"""
{KIND_OF_ACTIVITY_USER_TXT}
"""

INITIALIZATION_INSTRUCTION_PARAMS = f"""Can you help with following details: project_id, dataset_id, gcs_folder.
e.g: You can give input as:
project_id=<your_project_id>,dataset_id=<your_dataset_id>,gcs_folder=<your_gcs_folder>
"""
