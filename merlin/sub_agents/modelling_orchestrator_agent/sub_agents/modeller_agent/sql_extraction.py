...
GCS_PATHS_LIST_FILE = "/Users/abhijat/Downloads/BigQueryModellingAgent/repo/BigQueryModellingAgent/data_modelling_agent_v2/sub_agents/modelling_orchestrator_agent/sub_agents/modeller_agent/path_file.txt"
...
async def extract_from_sql_queries(
    ...
    try:
        ...
        print("continuing without sql extracted info..")
