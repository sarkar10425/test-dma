...
PHYSICAL_MODEL_SUFFIX = ".txt"
LOGICAL_MODEL_SUFFIX = ".csv"
CONCEPTUAL_MODEL_SUFFIX = ".txt"
ENTITY_CLASSIFICATION_SUFFIX = ".csv"
VALIDATION_REPORT_SUFFIX = ".txt"


agent_name_dict = {
    "Create Entity Classification": "EntityModellerAgent",
    "Entity Classification": "EntityModellerAgent",
    "Create Conceptual Data Model": "ConceptualModellerAgent",
    "Conceptual Data Model": "ConceptualModellerAgent",
    "Create Logical Data Model": "LogicalModellerAgent",
    "Logical Data Model": "LogicalModellerAgent",
    "Create Physical Data Model": "PhysicalModellerAgent",
    "Physical Data Model": "PhysicalModellerAgent",
    "Generate Validation Report": "ValidationAgent",
    "Validation Report": "ValidationAgent",
}

state_var_dict = {
    "Create Entity Classification": "entity_data_model",
    "Entity Classification": "entity_data_model",
    "Create Conceptual Data Model": "conceptual_data_model",
    "Conceptual Data Model": "conceptual_data_model",
    "Create Logical Data Model": "logical_data_model",
    "Logical Data Model": "logical_data_model",
    "Create Physical Data Model": "physical_data_model",
    "Physical Data Model": "physical_data_model",
    "Generate Validation Report": "validation_report",
    "Validation Report": "validation_report",
}
gcs_path_dict = {
    "Create Entity Classification": "outputs/entity_classification",
    "Entity Classification": "outputs/entity_classification",
    "Create Conceptual Data Model": "outputs/conceptual_model",
    "Conceptual Data Model": "outputs/conceptual_model",
    "Create Logical Data Model": "outputs/logical_model",
    "Logical Data Model": "outputs/logical_model",
    "Create Physical Data Model": "outputs/physical_model",
    "Physical Data Model": "outputs/physical_model",
    "Generate Validation Report": "outputs/validation_report",
...
BQ_PHYSICAL_MODEL_EXAMPLE = """Physical Suggestions Model (BigQuery DDL)
