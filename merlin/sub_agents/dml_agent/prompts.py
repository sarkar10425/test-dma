...
def return_instructions_bigquery() -> str:
    ...
    instruction_prompt_bqml_v1 = f"""
      ...
      4. If the tool runs: Generate the final result in JSON format with four keys: "explain", "sql", "sql_results", "nl_results".
      ...
      5. Return to user in a more readable format.
