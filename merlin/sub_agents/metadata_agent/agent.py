...
# from data_modelling_agent.sub_agents.search_agent.tools import call_source_search_agent
...
# from google.adk.tools.agent_tool import AgentTool
# from .sql_extraction import extract_from_sql_queries

# sql_queries_agent = Agent(
#     name="SQLQueriesAgent",
#     model=os.getenv("ROOT_AGENT_MODEL", "gemini-2.5-flash"),
#     description="""Responsible to extract info from source SQL Queries""",
#     instruction=f"""
#       You are an helpful assistant to extract information from provided SQL queries **without any user's inputs**.

#       **Tasks**
#         - *Must* invoke the 'extract_from_sql_queries' tool to search through SQL queries.
#         - If you are unable to fetch any data just put "N/A".


#     **Guardrails**
#     - Do not ask the user for providing input data, always use the 'extract_from_sql_queries' tool.
#     - Do not make up anything from your own knowledge.
#     """,
#     tools=[
#         extract_from_sql_queries
#         ],
# )
